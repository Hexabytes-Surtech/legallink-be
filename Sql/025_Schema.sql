...
\restrict awXSq0ojSZN3r8fgBYOqtxXcmnueRSePG5MAvK6ISyyw0ePxt5jzV8ALv0qoE4U
...
--
-- Name: push_subscription; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.push_subscription OWNER TO neondb_owner;
...
--
-- Name: push_subscription push_subscription_endpoint_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: push_subscription push_subscription_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_push_sub_user; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_push_sub_user ON public.push_subscription USING btree (user_id);
...
--
-- Name: push_subscription push_subscription_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.push_subscription
    ADD CONSTRAINT push_subscription_user_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
\unrestrict awXSq0ojSZN3r8fgBYOqtxXcmnueRSePG5MAvK6ISyyw0ePxt5jzV8ALv0qoE4U
